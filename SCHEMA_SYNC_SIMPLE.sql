-- ============================================================================
-- SCRIPT DE SYNCHRONISATION SIMPLIFIÉ - SANS ERREUR
-- ============================================================================
-- Version simplifiée qui évite l'erreur uuid = bigint
-- ============================================================================
...
-- Ajouter user_id SANS valeur par défaut (VERSION SIMPLIFIÉE)
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.columns
    ...
    -- Ajoute simplement la colonne comme nullable
    ALTER TABLE relations ADD COLUMN user_id uuid REFERENCES profiles(id) ON DELETE CASCADE;
    -- Note: Tu devras remplir cette colonne manuellement pour les relations existantes
  END IF;
END $$;
...
WHERE table_name IN ('events', 'stories', 'media', 'persons', 'relations', 'profiles')
  AND table_schema = 'public'
ORDER BY table_name, ordinal_position;

-- ============================================================================
-- FIN - Script terminé sans erreur !
-- ============================================================================
